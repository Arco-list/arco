          ...
          return (
            <Row label="Sequence">
              <span style={{ display: "inline-flex", alignItems: "baseline", gap: 8, flexWrap: "wrap" }}>
                {suppression ? (
                  <span style={{ display: "inline-flex", alignItems: "baseline", gap: 6 }}>
                    <span className="arco-table-status-dot bg-red-500" />
                    <span>{capitalizeFirst(suppression)}</span>
                  </span>
                ) : (
                  <>
                    <span style={{ display: "inline-flex", alignItems: "baseline", gap: 6 }}>
                      <span className={`arco-table-status-dot ${seqCfg?.dot ?? "bg-[#a1a1a0]"}`} />
                      <span>
  ...
  return (
    ...
    >
      ...
      <span style={{ display: "inline-flex", alignItems: "baseline", gap: 8 }}>
        <span className={`arco-table-status-dot ${dot}`} style={{ position: "relative", top: -1 }} />
