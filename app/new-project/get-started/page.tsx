    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-8 mb-24">
            <div>
              ...
              <h2 className="heading-5 text-foreground mb-2">Tell us about your project</h2>
            ...
            <div>
              ...
              <h2 className="heading-5 text-foreground mb-2">Create a photo tour</h2>
              <p className="body-small text-text-secondary leading-relaxed">
            ...
            <div>
              ...
              <h2 className="heading-5 text-foreground mb-2">Share who helped you realise it</h2>
              <p className="body-small text-text-secondary leading-relaxed">
