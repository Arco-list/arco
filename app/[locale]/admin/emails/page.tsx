...
const INITIAL_TEMPLATES: EmailTemplate[] = [
  ...
  { id: "outreach-intro", name: "Outreach Intro", type: "marketing", audience: "professional", description: "Cold outreach to companies with no Arco page yet", trigger: "Admin enrols Outreach contacts from /admin/sales", subject: "[First], [Company] past bij Arco", sends: 0, deliveryRate: 100, active: true, drip: "outreach", dripDay: 0, from: SENDERS.niek },
  { id: "outreach-followup", name: "Outreach Follow-up", type: "marketing", audience: "professional", description: "Follow-up if no response to Outreach intro", trigger: "Drip queue · 3 days after intro", subject: "Hoe architecten op Arco gevonden worden", sends: 0, deliveryRate: 100, active: true, drip: "outreach", dripDay: 3, from: SENDERS.niek },
  { id: "outreach-final", name: "Outreach Final", type: "marketing", audience: "professional", description: "Last reminder before Outreach sequence ends", trigger: "Drip queue · 10 days after intro", subject: "Laatste bericht — uitnodiging op Arco staat nog open", sends: 0, deliveryRate: 100, active: true, drip: "outreach", dripDay: 10, from: SENDERS.niek },
]
