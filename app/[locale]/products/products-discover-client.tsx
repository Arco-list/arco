      ...
      <div className="discover-filter-bar">
        <div className="wrap">
          <div className="discover-filter-inner">
            {/* All filters */}
            <button className="filter-pill" data-active={activeFilterCount > 0} onClick={clearAll}>
      ...
      <div className="discover-page-title">
        <div className="wrap">
          <nav aria-label="Breadcrumb" className="discover-breadcrumb">
            <Link href="/products" className="discover-breadcrumb-item" onClick={(e) => { if (selectedBrands.size > 0) { e.preventDefault(); clearAll() } }}>Products</Link>
            {singleBrand && (
              <>
          ...
          {singleBrand ? (
            /* Brand header */
            <div style={{ display: "flex", alignItems: "flex-start", gap: 32, marginTop: 16 }}>
              {singleBrand.logoUrl ? (
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {singleBrand.description && (
                  <p className="arco-body-text" style={{ marginTop: 12, maxWidth: 720 }}>{singleBrand.description}</p>
                )}
              </div>
            </div>
          ) : (
