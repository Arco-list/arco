-- Migration: Fix get_user_saved_companies_with_summary to use mv_company_listings
-- Description: Update function to use the new company-based view
...
COMMENT ON FUNCTION public.get_user_saved_companies_with_summary() IS
  'Fetches saved companies for a user with full company listing data in a single query';
