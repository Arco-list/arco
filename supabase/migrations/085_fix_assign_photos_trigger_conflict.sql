-- Migration: Fix assign_photos_to_feature trigger conflict
-- Description: Update photos sequentially to prevent BEFORE trigger conflicts
-- The bulk UPDATE causes conflicts with the ensure_single_primary_photo_trigger
...
BEGIN
  ...
  -- Update photos sequentially to avoid trigger conflicts
