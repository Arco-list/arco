-- Migration: Add primary_service_name to mv_professional_summary
-- Description: Use company.primary_service_id instead of services_offered[0]

-- Drop the existing view
DROP MATERIALIZED VIEW IF EXISTS public.mv_professional_summary CASCADE;

-- Recreate with primary_service_name
...
SELECT
  ...
  -- PRIMARY SERVICE (the main one displayed on cards)
