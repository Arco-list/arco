-- Migration: Support multiple city filters in search_professionals
-- Changes city_filter from TEXT to city_filters TEXT[] for multi-select location filtering
...
-- Recreate with city_filters TEXT[] instead of city_filter TEXT
