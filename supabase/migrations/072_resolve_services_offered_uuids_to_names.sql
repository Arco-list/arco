-- Migration: Resolve services_offered UUIDs to category names
-- Description: Update mv_professional_summary to convert UUID arrays to service name arrays
...
SELECT
  ...
  p.portfolio_url,
  p.languages_spoken,
  -- FIXED: Resolve UUIDs to category names
  (
