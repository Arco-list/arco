-- Migration: Performance optimizations and indexes (Updated)
-- Description: Additional indexes, materialized views, and performance enhancements without unnecessary views
...
-- =============================================================================
-- SEARCH FUNCTIONS WITH OPTIMIZED QUERIES
-- =============================================================================
...
-- Add comments
COMMENT ON MATERIALIZED VIEW public.mv_professional_summary IS 'Optimized professional data for listings and search - query directly for UI components';
