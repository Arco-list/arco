-- Migration: Rename admin_company_professional_metrics to company_metrics
-- Description: Removes misleading "admin_" prefix from public-facing view used on landing page
