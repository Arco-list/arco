-- Migration: Add primary_service_name to search_professionals RPC function
-- Description: Return primary_service_name so professional cards can display it
...
-- Recreate with primary_service_name in return type
